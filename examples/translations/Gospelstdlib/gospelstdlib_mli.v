...
Parameter app : forall A : Type, sequence A -> sequence A -> sequence A.
...
Parameter length : forall A : Type, sequence A -> Coq.Numbers.BinNums.Z.
...
Parameter empty : forall A : Type, sequence A.
...
Parameter rev : forall A : Type, sequence A -> sequence A.
...
(* Parameter init : forall A : Type, (A -> Coq.Numbers.BinNums.Z) -> bag A. *)
...
(* Parameter add : forall A : Type, A -> bag A -> bag A. *)
...
(* Definition singleton  (A : Type) (x : A) : bag A:= add x empty. *)

(* Definition mem  (A : Type) (x : A) (b : bag A) : Prop:= *)
(* gt (multiplicity x b) (0)%Z. *)

(* Parameter remove : forall A : Type, A -> bag A -> bag A. *)
...
(* Parameter sum : forall A : Type, bag A -> bag A -> bag A. *)
...
(* Parameter inter : forall A : Type, bag A -> bag A -> bag A. *)
...
(* Definition disjoint  (A : Type) (b : bag A) (b' : bag A) : Prop:= *)
(* forall A : Type, *)
(* forall x : A, *)
(* mem x b -> Coq.Init.Logic.not (mem x b'). *)

(* Definition subset  (A : Type) (b : bag A) (b' : bag A) : Prop:= *)
(* forall A : Type, *)
(* forall x : A, *)
(* le (multiplicity x b) (multiplicity x b'). *)

(* Parameter filter : forall A : Type, (A -> Prop) -> bag A -> bag A. *)
...
(* Parameter cardinal : forall A : Type, bag A -> Coq.Numbers.BinNums.Z. *)

(* Definition finite  (A : Type) (b : bag A) : Prop:= *)
(* forall A : Type, *)
(* Coq.Init.Logic.ex ( *)
(*   fun s : sequence A => *)
(*   forall x : A, *)
...
(* Parameter of_seq : forall A : Type, sequence A -> bag A. *)
...
(* Parameter mixfix {} : forall A : Type, set A. *)
...
(* Definition singleton  (A : Type) (x : A) : set A:= add x empty. *)
...
(* Definition disjoint  (A : Type) (s : set A) (s' : set A) : Prop:= *)
...
(* Definition subset  (A : Type) (s : set A) (s' : set A) : Prop:= *)
(* forall A : Type, *)
(* forall x : A, *)
(* mem x s -> mem x s'. *)
...
(* Parameter cardinal : forall A : Type, set A -> Coq.Numbers.BinNums.Z. *)

(* Definition finite  (A : Type) (s : set A) : Prop:= *)
(* forall A : Type, *)
(* Coq.Init.Logic.ex ( *)
(*   fun seq : sequence A => *)
(*   forall x : A, *)
...
(* Parameter of_seq : forall A : Type, sequence A -> set A. *)
...
(* (* Parameter get : forall A : Type, array A -> Coq.Numbers.BinNums.Z -> A. *) *)

(* (* Parameter length : forall A : Type, array A -> Coq.Numbers.BinNums.Z. *) *)

(* (* Parameter to_seq : forall A : Type, array A -> sequence A. *) *)

(* (* Parameter permut : forall A : Type, array A -> array A -> Prop. *) *)
...
(* (* Parameter _exists : forall A : Type, (A -> Prop) -> list A -> Prop. *) *)

(* (* Parameter length : forall A : Type, list A -> Coq.Numbers.BinNums.Z. *) *)

(* (* Parameter nth : forall A : Type, list A -> Coq.Numbers.BinNums.Z -> A. *) *)
...
(* (* Parameter is_pre_order : forall A : Type, (A -> A -> int) -> Prop. *) *)
...
(* (* Parameter prefix ! : forall A : Type, ref A -> A. *) *)
